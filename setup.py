...
f.close()
print(f'хорошо, скрипт настроен, авторизируйте spotify через эту ссылку:\nhttps://accounts.spotify.com/authorize?response_type=code&client_id={client_id}&scope=user-read-playback-state-user-libary-read&redirect_uri=http://localhost:8888')
